...
for name in ['build_paper.py','followup_tables.py','verify_evidence.py','sha256_measurement.tex','numbers.tex','followup_numbers.tex','graph_table.tex','sensitivity_table.tex','cube_table.tex','ml_table.tex','verification.json','test_results.txt']:include(P/name)
