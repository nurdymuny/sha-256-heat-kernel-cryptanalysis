...
def main():
    ...
    for rounds in test_rounds:
        ...
        if advantage > 0.02:
            ...
            print(f"    → Descriptive bias difference ({advantage:+.3f})")
    
    print("\n" + "=" * 70)
    print("  CONCLUSION")
    print("=" * 70)
    print("These are exploratory single-bit tests. Use publication_study.py for matched controls, saved observations and multiplicity-aware inference.")
